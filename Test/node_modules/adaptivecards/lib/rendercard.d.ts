import { Action, ShowCardAction, CardElement, HostConfig } from "./adaptivecards";
...
export declare function renderCard(card: IAdaptiveCard | string, options?: IRenderOptions, target?: HTMLElement): HTMLElement;
